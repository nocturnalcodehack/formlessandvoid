            ...
            <div className="item main-bg position-re o-hidden md-mb50">
              <div className="info-box pb-30 bord-thin-bottom mb-30">
                ...
                <div className="amount">
                  <div><span className="main-color3 num-font fw-600 fz-50">$19</span> <span
          ...
          <div className="col-lg-4">
            <div className="item main-bg position-re o-hidden md-mb50">
              <div className="info-box pb-30 bord-thin-bottom mb-30">
                <h6 className="sub-title mb-15">Basic Plan</h6>
                <div className="amount">
                  <div><span className="main-color3 num-font fw-600 fz-50">$49</span> <span
                    className="fz-14 fw-400">/ Mounth</span></div>
                </div>
                <p className="fz-13">10% taxes will include after make price.</p>
              </div>
          ...
          <div className="col-lg-4">
            <div className="item main-bg position-re o-hidden">
              <div className="info-box pb-30 bord-thin-bottom mb-30">
                <h6 className="sub-title mb-15">Basic Plan</h6>
                <div className="amount">
                  <div><span className="main-color3 num-font fw-600 fz-50">$79</span> <span
                    className="fz-14 fw-400">/ Mounth</span></div>
                </div>
                <p className="fz-13">10% taxes will include after make price.</p>
              </div>

...
//= Data
import data from 'src/data/InnerPages/Blog/classic.json';
              ...
              <div className="col-lg-4 col-md-6" key={item.id}>
                <div className={`item ${index !== data.length - 1 ? 'mb-50' : ''}`}>
                  <div className="img">
                    ...
                    <div className="date">
                      <Link href="/dark/blog-details">{item.date}</Link>
                    </div>
                  </div>
                  <div className="cont mt-30">
                    ...
                    <Link href="/dark/blog-details" className="mt-20 ls1 sub-title">Read More <i className="ml-5">
